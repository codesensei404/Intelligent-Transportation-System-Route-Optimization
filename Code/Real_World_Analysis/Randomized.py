...
from jensen import jensen_analysis, plot_gaussian, plot_jensen_curve
from gaussian_plot import plot_gaussian
...
optimal_path, success_prob, exp_time, exp_var = sota_a_star(G, source_node, dest_node, time_budget)
...
if not optimal_path:
    ...
    print("\n--- Post Analysis ---")
# Jensen Analysis
    jensen_analysis(exp_time, exp_var, time_budget)
# Gaussian curves
    plot_gaussian(exp_time, exp_var, time_budget)
# Jensen curve
    plot_jensen_curve(exp_time, exp_var, time_budget)
    ...
    filename = "dynamic_sota_map.html"
